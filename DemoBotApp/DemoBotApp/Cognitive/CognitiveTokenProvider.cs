...
{
    public sealed class CognitiveTokenProvider : IAuthorizationProvider
    {
        /// <summary>
        /// The fetch token URI
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CognitiveTokenProvider" /> class.
        /// </summary>
        /// <param name="subscriptionKey">The subscription identifier.</param>
        public CognitiveTokenProvider(string subscriptionKey)
        {
